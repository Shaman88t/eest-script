...
//////////////////////////////////////////////////////////////////////////
  ...
  //  Lodni linka 1 - Zril´Mar --> Charaxss
    ...
    stShip.m_sName      = "Zril´Mar - Charaxss";        // Nazev trasy
    stShip.m_nCost      = 100;                          // Cena listku
    stShip.m_nSpent     = 6;                            // cas, straveny na mori
    stShip.m_nMaxDelay  = 1;                            // Maximalni zpozdeni
    stShip.m_sMerchant  = "ph_otrokprod_zril";          // Tag prodavace listku
    stShip.m_sPort      = "ph_lod_zril_char_z";         // Tag bodu, odkud lod vyrazi
    stShip.m_sSea       = "ph_lod_zril_char_l";         // Tag bodu na mori
    stShip.m_sFinish    = "ph_lod_zril_char_c";         // Tag cile cesty
    stShip.m_sCabin     = "";                           // Tag kajuty
    stShip.m_sShouter_p = "ph_vyvolavac1";              // Tag vyvolavace v pristavu
    stShip.m_sShouter_s = "ph_kormidelnik1";            // Tag vyvolavace na mori
...
// Konec lodni linky
 ...
 //  Lodni linka 2 - Zril´Mar --> Hagol
    ...
    stShip.m_sName      = "Zril´Mar - Hagol";           // Nazev trasy
    stShip.m_nCost      = 100;                          // Cena listku
    stShip.m_nSpent     = 4;                            // cas, straveny na mori
    stShip.m_nMaxDelay  = 1;                            // Maximalni zpozdeni
    stShip.m_sMerchant  = "ph_otrokprod_zril";          // Tag prodavace listku
    stShip.m_sPort      = "ph_lod_zril_hag_z";          // Tag bodu, odkud lod vyrazi
    stShip.m_sSea       = "ph_lod_zril_hag_l";          // Tag bodu na mori
    stShip.m_sFinish    = "ph_lod_zril_hag_h";          // Tag cile cesty
    stShip.m_sCabin     = "";                           // Tag kajuty
    stShip.m_sShouter_p = "ph_vyvolavac1";              // Tag vyvolavace v pristavu
    stShip.m_sShouter_s = "ph_kormidelnik2";            // Tag vyvolavace na mori
