...
void Summon9Select(){
    ...
    iP2 = iT;
         ...
         if ( dlgIsSelectionEqualToName( "Beholder *9*" ) ) setVarsToSummonOnPC(iLVL , "ry_sum_9_f", "", iP2, ALIGNMENT_EVIL, dlgGetSpeakingPC(), GetAlignmentGoodEvil(dlgGetSpeakingPC()), 0);
    else if ( dlgIsSelectionEqualToName( "Klepetnatec okrovy *9*" ) ) setVarsToSummonOnPC(iLVL , "ry_sum_9_h", "", iP2, ALIGNMENT_EVIL, dlgGetSpeakingPC(), GetAlignmentGoodEvil(dlgGetSpeakingPC()), 0);
