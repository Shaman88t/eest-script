...
case 2: { no_jmeno = no_jmeno +"meden";
            break;    }
case 3: { no_jmeno = no_jmeno +"Bronzov";
            break;    }
...
switch (no_random)  {
case 1: {
                    itemproperty no_ip = ItemPropertyDamageBonusVsRace(IP_CONST_RACIALTYPE_HUMANOID_GOBLINOID,IP_CONST_DAMAGETYPE_SONIC,IP_CONST_DAMAGEBONUS_1d6);
                  ...
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                    break;}
case 2: {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_COLD,2+d2());
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
case 3: {
                  ...
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 4: {
            itemproperty no_ip = ItemPropertyDamageBonusVsRace(IP_CONST_RACIALTYPE_DRAGON,IP_CONST_DAMAGETYPE_FIRE,IP_CONST_DAMAGEBONUS_1d8);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
case 8: {
            ...
            SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case  9: {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_ELECTRICAL,2+d2());
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
case 16:  {
                 itemproperty no_ip = ItemPropertyACBonusVsSAlign(IP_CONST_ALIGNMENTGROUP_EVIL,2);
                  ...
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 17:  {
                itemproperty no_ip =ItemPropertyDamageBonusVsAlign(IP_CONST_ALIGNMENTGROUP_EVIL,IP_CONST_DAMAGETYPE_DIVINE,IP_CONST_DAMAGEBONUS_1d4);
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyVisualEffect(ITEM_VISUAL_HOLY),no_Item);
...
switch   (no_kov_co_pridavam){
        ...
        case 1:  {  switch (no_kov_pridame_procenta) {
             //cÌn
                        ...
                        case 4: { no_bonus_vylepseni = no_bonus_vylepseni -3;
                                    break;  }
                        case 6: { no_bonus_vylepseni = no_bonus_vylepseni -3;
                                    break;  }
                        case 8: { no_bonus_vylepseni = no_bonus_vylepseni -4;
                                    break;  }
                        case 10: { no_bonus_vylepseni = no_bonus_vylepseni -4;
                                    break;  }
                        case 12: { no_bonus_vylepseni = no_bonus_vylepseni -5;
                                    break;  }
                        case 14: { no_bonus_vylepseni = no_bonus_vylepseni -5;
                                    break;  }
                        case 16: { no_bonus_vylepseni = no_bonus_vylepseni -6;
                                    break;  }
                        case 18: { no_bonus_vylepseni = no_bonus_vylepseni -6;
                                    break;  }
                        case 20: { no_bonus_vylepseni = no_bonus_vylepseni -7;
                                    break;  }
        ...
        case 2:  {  switch (no_kov_pridame_procenta) {
             //meÔ
                        ...
                        case 16: {  no_bonus_vylepseni = no_bonus_vylepseni -4;
                                    break;  }
                        case 18: {  no_bonus_vylepseni = no_bonus_vylepseni -5;
                                    break;  }
        ...
        case 3:  {  switch (no_kov_pridame_procenta) {
             //brondz
                        case 2: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,1),no_Item);
                                    break;  }
                        case 4: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,2),no_Item);
                                    break;  }
                        case 6: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,3),no_Item);
                                    break;  }
                        case 8: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,4),no_Item);
                                    break;  }
                        case 10: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,5),no_Item);
                                    break;  }
                        case 12: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,6),no_Item);
                                    break;  }
                        case 14: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,7),no_Item);
                                    break;  }
                        case 16: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,8),no_Item);
                                    break;  }
                        case 18: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,9),no_Item);
                                    break;  }
        ...
        case 4:  {  switch (no_kov_pridame_procenta) {
             //ûelezo
                        ...
                        case 14: {  no_bonus_vylepseni = no_bonus_vylepseni +1;
                                    if (no_max_bonus==3) AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_SLASHING,IP_CONST_DAMAGEBONUS_1),no_Item);
                                    break;  }
                        case 16: {  no_bonus_vylepseni = no_bonus_vylepseni +1;
        ...
        case 5:  {  switch (no_kov_pridame_procenta) {
             //zlato
                        ...
                        case 4: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,2),no_Item);
                                    break;  }
                        case 6: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,2),no_Item);
                                    break; }
                        case 8: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,3),no_Item);
                                    break;  }
                        case 10: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,3),no_Item);
                                    break;  }
                        case 12: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,4),no_Item);
                                    break;  }
                        case 14: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,4),no_Item);
                                    break;  }
                        case 16: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,5),no_Item);
                                    break;  }
                        case 18: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_OUTSIDER,5),no_Item);
                                    break;  }
        ...
        case 10:  {  switch (no_kov_pridame_procenta) {
             //striebro
                        case 2: {
                                    break;  }
                        case 4: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,1),no_Item);
                                    break;  }
                        case 6: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,2),no_Item);
                                    break; }
                        case 8: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,2),no_Item);
                                    break;  }
                        case 10: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,3),no_Item);
                                    break;  }
                        ...
                        case 18: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,6),no_Item);
                                    break;  }
                        case 20: {  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,7),no_Item);
                                    break;  }
                        } //konec vnitrniho switche
                break;    }//konec stribra
        ...
        case 12:  {  switch (no_kov_pridame_procenta) {
             //meteorick· oceæ
                        ...
                        case 20: {  no_bonus_vylepseni = no_bonus_vylepseni +5;
                                    jy_kritik = jy_kritik +4;
                                    if (no_max_bonus==1) no_magicky_bonus = no_magicky_bonus +2;
                                    if (no_max_bonus==2) no_magicky_bonus = no_magicky_bonus +3;
                                    if (no_max_bonus==3) no_magicky_bonus = no_magicky_bonus +4;
                                    break;  }
                        } //konec vnitrniho switche
...
case 3: {no_menu_nazev_kovu = "bronz";   break;}
...
case 3: {no_menu_nazev_kovu2 = "bronz";   break;}
...
FloatingTextStringOnCreature("Neplatny vzhled zmenen na: " + IntToString(no_platny_index) ,no_oPC ,FALSE);
