...
// vyresi moznost uspechu a preda pripadny kus drea do no_pec
{
        ...
        case 1:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_1"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 2:  {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_2"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 3:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_3"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 4:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_4"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 5:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_5"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 6:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_6"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);       //no_pec je tam , at se objevi v peci a muze se rovnou zvetsit %
                   break; }
        case 7:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_7"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 8:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_8"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 9:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_9"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 10:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_10"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 11:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_11"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 12:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_12"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 13:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_13"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 14:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_14"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
        case 15:   {SetLocalFloat(CreateItemOnObject("no_polot_br",no_pec,1,"no_nuget_15"),"no_suse_proc",10.0);
                   no_xp_kamen(no_oPC,no_pec);
                   break; }
