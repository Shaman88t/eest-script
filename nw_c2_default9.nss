...
/* 19.10.2008 Zpozdeno spousteni Igorovych scriptu pro nemoce a dyn. boosty
 */
...
************************* [Fleeing] *******************************************/
    ...
    SetAIInteger(AI_DAMAGE_AT_ONCE_PENALTY, 3);
...
************************* [Combat - Spell Casters] ****************************/
    ...
    if(ai_boss) SetSpawnInCondition(AI_FLAG_COMBAT_FLAG_FAST_BUFF_ENEMY, AI_COMBAT_MASTER);
...
************************* [Other - Behaviour/Generic] *************************/
    ...
    SetAIConstant(LAG_AI_LEVEL_YES_PC_OR_ENEMY_50M, AI_LEVEL_NORMAL);
        // Changes to this AI setting if there IS an enemy or PC in 50M.
    if(ai_boss){
        SetAIConstant(LAG_AI_LEVEL_COMBAT, AI_LEVEL_HIGH);
    }
    else{
...
void main(){
 ...
 DelayCommand(0.1f, henchmancheck());
