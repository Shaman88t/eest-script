...
// vtvori polotovar s nastavenm promenma tak, aby z nej mohlo jit pouze pres slose udelat hotovej vyrobek.
{
        ///////////////udelame polotovar////////////////////
        switch(no_druh) {
        case 1:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_1"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 2:  {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_2"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 3:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_3"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 4:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_4"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 5:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_5"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 6:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_6"),"no_suse_proc",10.0);
...
// vtvori polotovar s nastavenm promenma tak, aby z nej mohlo jit pouze pres close udelat hotovej vyrobek.
{
        ///////////////udelame polotovar////////////////////
        switch(no_druh) {
        case 1:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_51"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 2:  {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_52"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 3:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_53"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 4:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_54"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 5:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_55"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 6:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_56"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);       //no_pec je tam , at se objevi v peci a muze se rovnou zvetsit %
                   break; }
                } //konec vnitrniho  switche
...
// vtvori polotovar s nastavenm promenma tak, aby z nej mohlo jit pouze pres close udelat hotovej vyrobek.
{
        ///////////////udelame polotovar////////////////////
        switch(no_druh) {
        case 1:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_101"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 2:  {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_102"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 3:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_103"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 4:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_104"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 5:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_105"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);
                   break; }
        case 6:   {SetLocalFloat(CreateItemOnObject("no_polot_ko",no_pec,1,"no_suse_106"),"no_suse_proc",10.0);
                   no_xp_kuze(no_oPC,no_pec);       //no_pec je tam , at se objevi v peci a muze se rovnou zvetsit %
                   break; }
                } //konec vnitrniho  switche
