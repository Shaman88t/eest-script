...
if (GetIsObjectValid(no_Item)) {
           ...
           if(Random(100) > 90)
           {
           SpeakString(" *pred tvyma ocima vse vysype do kose* Vzdyt je to vsechno uplne zkazene ! jak dlouho si to proboha mel v batohu! ");
           //je 10% sance ze vyhodi nasbirane veci do kose...
           while (no_pocet > 0 )  {
