...
{
switch(no_kov) {
        case 1:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_pise"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
        case 2:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_jil"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
                   }
} // konec no_xp_cisteni
...
switch(no_kov) {
        case 2:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_lahe"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
        case 4:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_ampu"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
                   }
} // konec no_xp_sklo
...
int no_level = TC_getLevel(no_oPC,TC_KERAM);
switch(no_kov) {
        case 1:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_mala"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
        case 3:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_tenk"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
        case 5:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_stre"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
        case 6:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_velk"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
        case 7:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_zahn"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
        case 8:   {SetLocalFloat(CreateItemOnObject("no_polot_ke",no_pec,1,"no_ke_kuli"),"no_suse_proc",10.0);
                   no_xp_ke(no_oPC,no_pec);
                   break; }
                } //konec vnitrniho  switche
