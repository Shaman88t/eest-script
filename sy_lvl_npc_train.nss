...
string sy_get_remeslo()
{
    ...
    switch (nClass)
    {
        ...
        case CLASS_TYPE_BLACKGUARD      : return "cerne strazce";
        case CLASS_TYPE_CLERIC          : return "kneze";
        case CLASS_TYPE_DIVINE_CHAMPION : return "sampiony usvitu";
        ...
        case CLASS_TYPE_ROGUE           : return "zlodeje";
...
int KU_GetPriceForClass()
{
    ...
    switch (nClass)
    {
        case CLASS_TYPE_ARCANE_ARCHER   : return 25;
        case CLASS_TYPE_ASSASSIN        : return 25;
        case CLASS_TYPE_BARBARIAN       : return 10;
        case CLASS_TYPE_BARD            : return 15;
        case CLASS_TYPE_BLACKGUARD      : return 25;
        case CLASS_TYPE_CLERIC          : return 15;
        case CLASS_TYPE_DIVINE_CHAMPION : return 25;
        case CLASS_TYPE_DRAGON_DISCIPLE : return 25;
        case CLASS_TYPE_DRUID           : return 15;
        case CLASS_TYPE_DWARVEN_DEFENDER : return 25;
        case CLASS_TYPE_FIGHTER         : return 10;
        case CLASS_TYPE_HARPER          : return 25;
        case CLASS_TYPE_MONK            : return 10;
        case CLASS_TYPE_PALADIN         : return 10;
        case CLASS_TYPE_PALE_MASTER     : return 25;
        case CLASS_TYPE_RANGER          : return 10;
        case CLASS_TYPE_ROGUE           : return 10;
        case CLASS_TYPE_SHADOWDANCER    : return 25;
        case CLASS_TYPE_SHIFTER         : return 25;
        case CLASS_TYPE_SORCERER        : return 20;
        case CLASS_TYPE_WEAPON_MASTER   : return 25;
        case CLASS_TYPE_WIZARD          : return 20;
    }
    return 100;
}
...
    nLvlCost = FloatToInt(fPrice * nLvlCost);
    ...
    int nLevel2 = GetXP(oPC) - (((nLevel * (nLevel - 1)) / 2) * 1000);
    if (nLevel2<0)
    {
