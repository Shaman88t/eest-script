...
if ( no_random== 2) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_FIRE,3);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
itemproperty no_ip = ItemPropertyACBonusVsSAlign(IP_CONST_ALIGNMENTGROUP_CHAOTIC,1);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                          SetName(no_Item,GetName(no_Item) + "  'Chaos'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);}
if ( no_random== 4) {
itemproperty no_ip = ItemPropertyACBonusVsSAlign(IP_CONST_ALIGNMENTGROUP_LAWFUL,1);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                          SetName(no_Item,GetName(no_Item) + "  'Zakonak'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);}
if ( no_random== 5) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_NEGATIVE,3);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
        no_ip = ItemPropertyReducedSavingThrowVsX(IP_CONST_SAVEVS_POSITIVE,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Pozitivni'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 6) {
...
itemproperty no_ip =ItemPropertySkillBonus(SKILL_SPELLCRAFT,1);
                    AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                            SetName(no_Item,GetName(no_Item) + "  'Carorec'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);}
if ( no_random== 8) {
itemproperty no_ip =ItemPropertySkillBonus(SKILL_PARRY,1);
                    AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                            SetName(no_Item,GetName(no_Item) + "  'Chranic'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);}
if ( no_random== 9) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DIVINE,3);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
        no_ip = ItemPropertyReducedSavingThrowVsX(IP_CONST_SAVEVS_ELECTRICAL,2);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
itemproperty no_ip =ItemPropertySkillBonus(SKILL_BLUFF,1);
                    AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                            SetName(no_Item,GetName(no_Item) + "  'Blafak'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);}
if ( no_random== 11) {
itemproperty no_ip =ItemPropertySkillBonus(SKILL_APPRAISE,1);
                    AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                            SetName(no_Item,GetName(no_Item) + "  'Plny mesec'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);}
if ( no_random== 12) {
itemproperty no_ip = ItemPropertyLight (IP_CONST_LIGHTBRIGHTNESS_BRIGHT, IP_CONST_LIGHTCOLOR_YELLOW);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                          SetName(no_Item,GetName(no_Item) + "  'Svitilka'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);}
        }//konec ifu
if ( no_random== 13) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_POSITIVE,3);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
        no_ip = ItemPropertyReducedSavingThrowVsX(IP_CONST_SAVEVS_NEGATIVE,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Negativni'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 14) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_MINDAFFECTING,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Pozitivni mysl'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 15) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_SONIC,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Zatka do usi'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 16) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_FEAR,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'nebojsa'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 17) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DEATH,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Smrtonos'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 18) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DISEASE,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Dobry zaludek'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 19) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_POISON,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Hadi jed'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
if ( no_random== 20) {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_ACID,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                SetName(no_Item,GetName(no_Item) + "  'Kysela kuze'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
        }
