...
void main()
{
  ...
  // Weapon Crafting
  CnrAddCraftingDevice ("cnrAnvilPublic");
  //CnrAddCraftingDevice ("cnrBrazierSilv");
  //CnrAddCraftingDevice ("cnrBrazierTita");

  // Armor Crafting
  CnrAddCraftingDevice ("cnrAnvilArmor");
  ...
  // Infusing
  CnrAddCraftingDevice ("cnrInfusingMinor");
  CnrAddCraftingDevice ("cnrInfusingLess");
  CnrAddCraftingDevice ("cnrInfusingAver");
