...
while(GetIsObjectValid(no_Item))  {
    ...
    { SetLocalInt(no_pec,"no_ruda",2);
        no_snizstack(no_Item,no_mazani);
    break;      }
 //     if(GetTag(no_Item) == "cnrNuggetBron")
...
// vyresi moznost uspechu a preda pripadny povedeny kov do pece
{       switch(no_kov)   {
        case 1:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_tin");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 2:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_copp");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 3:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_bron");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 4:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_iron");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 5:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_gold");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 6:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_plat");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 7:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_mith");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 8:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_adam");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 9:   {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_tita");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 10:  {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_silv");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 11:  {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_stin");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
        case 12:  {CreateItemOnObject("no_polot_sl",no_pec,1,"no_sl_n_mete");
                   no_xp_sl(no_oPC,no_pec);
                   break; }
                } //konec vnitrniho  switche
