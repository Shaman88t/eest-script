...
const string no_verzecraftu =  "26.09.10";  // bude u kazdeho vyrobku napsane, at vime, jak je to starej vyrobek
...
// brusicstvi = 23
// kozeluzstvi = 24
const float no_zl_delay = 8.0; ///pouzivane u vsech animaci a zamknuti
const float no_br_delay = 5.0;
const float no_dr_delay = 5.0; ///pouzivane u vsech animaci a zamknuti
const float no_ke_delay = 5.0;
const float no_ko_delay = 5.0;
const float no_oc_delay = 8.0;
const float no_pl_delay = 8.0; ///pouzivane u vsech animaci a zamknuti
const float no_sl_delay = 5.0;
const float no_zb_delay = 8.0; ///pouzivane u vsech animaci a zamknuti
const float no_si_delay = 8.0;
const float no_tr_delay = 8.0;
...
const int  no_cena_kame_1  =20;
const int  no_cena_kame_7 =  60;
const int  no_cena_kame_2 = 130;
const int  no_cena_kame_14  = 260;
const int  no_cena_kame_4  = 500;
const int  no_cena_kame_3  = 800;
const int  no_cena_kame_15 = 1700;
const int  no_cena_kame_11  = 3500;
const int  no_cena_kame_13  = 4000;
const int  no_cena_kame_10  = 4500;
const int  no_cena_kame_8  = 5000;
const int  no_cena_kame_9 = 6000;
const int  no_cena_kame_5  = 7000;
const int  no_cena_kame_6  = 8000;
...
const int no_cena_tin = 20;
const int no_cena_copp = 70;
const int no_cena_bron = 100;
const int no_cena_iron = 200;
const int no_cena_gold = 400;
const int no_cena_plat = 900;
const int no_cena_mith = 2000;
const int no_cena_adam = 5200;
const int no_cena_tita = 6000;
...
// konec cena za formy//
         ...
         //ceny  nasad
const int  no_cena_nasa_vrb =   20;
const int  no_cena_nasa_ore =  160;
const int  no_cena_nasa_dub =  500;
const int  no_cena_nasa_mah =  1200;
...
const int  no_cena_nasa_pra =  10000;
       ...
       //cena
const int  no_cena_kozk_obyc =  20;
const int  no_cena_kozk_leps =  160;
const int  no_cena_kozk_kval =  600;
const int  no_cena_kozk_mist =  2000;
const int  no_cena_kozk_velm =  6000;
...
const int no_cena_prisada3 = 400;  //bronz
