...
switch (no_random)  {
case 1: {
                   itemproperty no_ip = ItemPropertyACBonusVsAlign(IP_CONST_ALIGNMENTGROUP_EVIL,1);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Zlako stit'");
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                    break;}
case 2: {
        itemproperty no_ip = ItemPropertyACBonusVsAlign(IP_CONST_ALIGNMENTGROUP_GOOD,1);
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
        SetName(no_Item,GetName(no_Item) + "  'Hodnak'");
        SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 3: {
...
case  11:  {
        itemproperty no_ip =ItemPropertySkillBonus(SKILL_APPRAISE,2);
                   ...
                   break;}
case 12:  {
                itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_SONIC,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Ucpavka usi'");
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 13:  {
                itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DIVINE,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Bozsky stit'");
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 14:  {
                 itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DISEASE,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Chorobo pryc'");
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 15:  {
                 itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_POSITIVE,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Zivy stit'");
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 16:  {
                  itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_NEGATIVE,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Mrtvak'");
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 17:  {
                 itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_FEAR,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
case 18:  {
                 ...
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  ...
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 19:  {
                 itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DEATH,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Smrto pryc'");
                  SetLocalInt(no_Item,"tc_cena",GetLocalInt(no_Item,"tc_cena")+ 100);
                   break;}
case 20:  {
                 itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_POISON,1+d2());
                 AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
switch   (no_sutr_co_pridavam){
        ...
        case 8:  {  switch (no_sutr_pridame_procenta) {
                         case 2: {   if ( GetLocalInt(OBJECT_SELF,"no_kovsperku")<2 ) {
                                    ...
                                    break;  }
                        case 4: { if ( GetLocalInt(OBJECT_SELF,"no_kovsperku")<2 ) {
                                    AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_POISON,2),no_Item);
                                          }
                                          if ( GetLocalInt(OBJECT_SELF,"no_kovsperku")>1 ) {
                                    AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                          }
                                    break;  }
                        case 6: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                    break;  }
                        case 8: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                    break;  }
                        case 10: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                    break;  }
                        case 12: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(3),no_Item);
                                    break;  }
                        case 14: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(3),no_Item);
                                    break;  }
                        case 16: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(4),no_Item);
                                    break;  }
                        case 18: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(4),no_Item);
                                    break;  }
                        case 20: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(5),no_Item);
                                    break;  }
                        case 22: { AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(6),no_Item);
                                    break;  }
                        } //konec vnitrniho switche
        ...
        case 15:  {  switch (no_sutr_pridame_procenta) {
                        ...
                        case 8: { if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="pr"){
                                    ...
                                    if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="am"){
                                        AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DEATH,3),no_Item);
                                         }
                                    break;  }
                        case 10: { if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="pr"){
                                    ...
                                    if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="am"){
                                        AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DEATH,4),no_Item);
                                         }
                                   break;  }
                        case 12: { if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="pr"){
                                    ...
                                    if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="am"){
                                        AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_DEATH,5),no_Item);
                                         }
                                   break;  }
                        case 14: {  if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="pr"){
                                    ...
                                    if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="am"){
                                        AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_UNIVERSAL,1),no_Item);
                                         }
                                    break;  }
                        ...
                        case 18: { if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="pr"){
                                    ...
                                    if  (GetLocalString(OBJECT_SELF,"no_druh_vyrobku")=="am"){
                                        AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_UNIVERSAL,2),no_Item);
                                         }
                                    break;  }
