...
void main()
{
    ...
    if(!GetLocalInt( oItem, "SOCKETS" )) return;
    ...
    {
         FloatingTextStringOnCreature("Mozes zamerat len veci v svojom vlastnictve", oPC);
    }
    else if(sGemType == "")
    {
        FloatingTextStringOnCreature("Tuto vec nemozes vlozit do slotu", oPC);
    }
