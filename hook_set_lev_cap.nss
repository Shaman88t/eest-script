...
void main()
{
  ...
  CnrSetTradeskillLevelCapByType(OBJECT_SELF, CNR_TRADESKILL_INFUSING, 10);
...
//  int nPrimaryClassType = GetClassByPosition(1, OBJECT_SELF);
  ...
  else if (nRacialType == RACIAL_TYPE_ELF)
  {
    ...
    CnrSetTradeskillLevelCapByType(OBJECT_SELF, CNR_TRADESKILL_INFUSING, 20);
  }
  ...
  else if (nRacialType == RACIAL_TYPE_HALFELF)
  {
    ...
    CnrSetTradeskillLevelCapByType(OBJECT_SELF, CNR_TRADESKILL_INFUSING, 15);
  }
