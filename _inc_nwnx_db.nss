...
string GetCharacterGUID(object oPlayer)
{
    return "SHA('" + GetName(oPlayer) + "@" + GetModuleName() + "')";
}

string GetCharacterTag(object oPlayer)
{
    return "SHA('" + GetPCPlayerName(oPlayer) + "')";
}

string GetModuleMUID()
{
    return "SHA('" + GetModuleName() + "')";
}
