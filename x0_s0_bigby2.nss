...
// End of Spell Cast Hook
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
        ...
        if(!MyResistSpell(OBJECT_SELF, oTarget))
        {
            ...
            int nCasterRoll = 10+GetCasterLevel(OBJECT_SELF)+nCasterModifier;//d20(1) + 14;
            int nTargetRoll = GetSkillRank(SKILL_DISCIPLINE, oTarget)+d20(); //d20(1) + GetAbilityModifier(ABILITY_STRENGTH, oTarget) + GetSizeModifier(oTarget);
