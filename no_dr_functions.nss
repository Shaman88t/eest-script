...
int no_level = TC_getLevel(no_oPC,TC_DREVO);
switch(no_druh_dreva) {
        case 1:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_vrb"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
        case 2:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_ore"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
        case 3:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_dub"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
        case 4:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_mah"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
        case 5:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_tis"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
        case 6:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_jil"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
        case 7:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_zel"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
        case 8:   {SetLocalFloat(CreateItemOnObject("no_polot_dr",no_pec,1,"no_dr_n_pra"),"no_suse_proc",10.0);
                   no_xp_dr(no_oPC,no_pec);
                   break; }
         }
} // konec no_xp_lat
