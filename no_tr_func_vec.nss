...
itemproperty no_ip = ItemPropertyACBonusVsSAlign(IP_CONST_ALIGNMENTGROUP_EVIL,1);
                  ...
                  SetName(no_Item,GetName(no_Item) + "  'Dobrak'");
...
case 2: {
        ...
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                          SetName(no_Item,GetName(no_Item) + "  'Chladilka'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
        break;}
case 3: {
        itemproperty no_ip = ItemPropertyACBonusVsSAlign(IP_CONST_ALIGNMENTGROUP_CHAOTIC,1);
                  ...
                  break;}
case 4: {
            itemproperty no_ip = ItemPropertyACBonusVsSAlign(IP_CONST_ALIGNMENTGROUP_LAWFUL,1);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                                    SetName(no_Item,GetName(no_Item) + "  'Neutralak'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
                  break;}
case 5: {
            itemproperty no_ip =ItemPropertyACBonusVsSAlign(IP_CONST_ALIGNMENTGROUP_NEUTRAL,1);
                   AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                                     SetName(no_Item,GetName(no_Item) + "  'Ochrance'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
                   break;}
case 6: {
            itemproperty no_ip = ItemPropertyLight (IP_CONST_LIGHTBRIGHTNESS_BRIGHT, IP_CONST_LIGHTCOLOR_BLUE);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                                    SetName(no_Item,GetName(no_Item) + "  'Svitivak'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
                  break;}
case 7: {
            itemproperty no_ip =ItemPropertySkillBonus(SKILL_SPELLCRAFT,1);
                    AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                  SetName(no_Item,GetName(no_Item) + "  'Magicka'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
                    break;}
case 8: {
            AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrow(IP_CONST_SAVEBASETYPE_WILL,d2()),no_Item);
                              SetName(no_Item,GetName(no_Item) + "  'Zelezna vule'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
            break;}
case  9: {
        itemproperty no_ip = ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_ELECTRICAL,1+d2());
        AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
        ...
        break;}
case 10:  {
        itemproperty no_ip =ItemPropertySkillBonus(SKILL_BLUFF,1);
                    AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                                      SetName(no_Item,GetName(no_Item) + "  'Oblafovac'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
                    break;}
case  11:  {
        itemproperty no_ip =ItemPropertySkillBonus(SKILL_APPRAISE,1);
                    AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
                                      SetName(no_Item,GetName(no_Item) + "  'Vyjednavac'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
                    break;}
case 12:  {
                itemproperty no_ip = ItemPropertyLight (IP_CONST_LIGHTBRIGHTNESS_BRIGHT, IP_CONST_LIGHTCOLOR_YELLOW);
                  AddItemProperty(DURATION_TYPE_PERMANENT,no_ip,no_Item);
...
case 5: {
                  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrowVsX(IP_CONST_SAVEVS_NEGATIVE,d2() ),no_Item);
                                    SetName(no_Item,GetName(no_Item) + "  'Pozitivni stit'");
                  SetLocalFloat(no_Item,"tc_cena",GetLocalFloat(no_Item,"tc_cena")+ 100);
                  break;}
case 6: {
...
case 8: {
                  AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSavingThrow(IP_CONST_SAVEBASETYPE_FORTITUDE,1),no_Item);
                                    SetName(no_Item,GetName(no_Item) + "  'Silny stit'");
...
void no_krluk(object no_pec)
{
     ...
     switch (GetLocalInt(OBJECT_SELF,"no_pouzite_drevo")){
          case 1:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(4),no_Item);
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(4),no_Item);
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(3),no_Item);
                                 break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(3),no_Item);
                                 break;  }
                    case 5:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(3),no_Item);
                                 break;  }
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(2),no_Item);
                                 break;  }
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(2),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(2),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(1),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(1),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(1),no_Item);
                                 break;  }
          ...
          case 2:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(3),no_Item);
                                 break;  }
                    ...
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(1),no_Item);
                                 break;  }
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,1),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
          ...
          case 3:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(3),no_Item);
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(2),no_Item);
                                 break;  }
                    case 3:  {   break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 5:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,2),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
          ...
          case 4:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(2),no_Item);
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(2),no_Item);
                                 break;  }
                    case 3:  {   break;  }
                    ...
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                    ...
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(2),no_Item);
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
          ...
          case 5:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackPenalty(1),no_Item);
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                    ...
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(2),no_Item);
                                 break;  }
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
          ...
          case 6:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1d6),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(2),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,5),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
          ...
          case 7:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 2:  {
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
                                 break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                    ...
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(1),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1d6),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(4),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,6),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_3),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
          ...
          case 8:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1),no_Item);
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
                                 break;  }
                    ...
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(3),no_Item);
                                 break;  }
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1d6),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(2),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                    ...
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(3),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,7),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1d4),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_3),no_Item);
          ...
          case 7:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 ...
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2d8),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(5),no_Item);
                                 break;  }
                    }//konec vnitrniho switche
               no_udelejjmeno(no_Item);
 ...
 case 8:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 ...
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(5),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2d10),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(6),no_Item);
                                 break;  }
                    }//konec vnitrniho switche
               no_udelejjmeno(no_Item);
          ...
          case 6:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 ...
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1d10),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(4),no_Item);
                                 break;  }
                    }//konec vnitrniho switche
               no_udelejjmeno(no_Item);
     ...
     switch (GetLocalInt(OBJECT_SELF,"no_pouzite_drevo")){
          ...
          case 7:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1d4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(9),no_Item);
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2d10),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(7),no_Item);
          ...
          case 8:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2),no_Item);
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_3),no_Item);
                                 break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(2),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(4),no_Item);
                                 break;  }
                    case 5:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2d8),no_Item);
                                 break;  }
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(6),no_Item);
                                 break;  }
                    ...
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_1d6),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(10),no_Item);
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyAttackBonus(5),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMassiveCritical(IP_CONST_DAMAGEBONUS_2d12),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyMaxRangeStrengthMod(8),no_Item);
                                 break;  }
                    }//konec vnitrniho switche
               no_udelejjmeno(no_Item);
...
void no_stit(object no_pec, int no_druh_stitu)
{
     ...
     switch (GetLocalInt(OBJECT_SELF,"no_pouzite_drevo")) {
          ...
          case 1:  {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDecreaseAC(IP_CONST_ACMODIFIERTYPE_SHIELD,3),no_Item);
                                 ...
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,3),no_Item);
                                 ...
                                 break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 5:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_5_PERCENT),no_Item);
                                 break;  }
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSpellResistance(IP_CONST_SPELLRESISTANCEBONUS_10),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyWeightReduction(IP_CONST_REDUCEDWEIGHT_10_PERCENT),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsDmgType(IP_CONST_DAMAGETYPE_PIERCING,1),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,1),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,1),no_Item);
                                 break;  }
          ...
          case 2:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 5:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_ACID,IP_CONST_DAMAGERESIST_5),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_5_PERCENT),no_Item);
                                 break;  }
                    case 6:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyBonusSpellResistance(IP_CONST_SPELLRESISTANCEBONUS_12),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyWeightReduction(IP_CONST_REDUCEDWEIGHT_10_PERCENT),no_Item);
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,2),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 ...
                                 break;  }
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,3),no_Item);
                                 break;  }
               }//konec vnitrniho switche
               no_udelejjmeno(no_Item);
               no_cenavyrobku(no_Item);
          ...
          case 3:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDecreaseAC(IP_CONST_ACMODIFIERTYPE_SHIELD,2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,5),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_5_PERCENT),no_Item);
                                 break;  }
                    ...
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 ...
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,3),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,3),no_Item);
          ...
          case 4:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 5:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_ACID,IP_CONST_DAMAGERESIST_10),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_5_PERCENT),no_Item);
                                 break;  }
                    ...
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,4),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    ...
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_FIRE,IP_CONST_DAMAGERESIST_5),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,5),no_Item);
                                 break;  }
               }//konec vnitrniho switche
               no_udelejjmeno(no_Item);
               no_cenavyrobku(no_Item);
          ...
          case 5:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    ...
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDecreaseAC(IP_CONST_ACMODIFIERTYPE_SHIELD,1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,7),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_5_PERCENT),no_Item);
                                 break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                    ...
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 ...
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsDmgType(IP_CONST_DAMAGETYPE_PIERCING,3),no_Item);
                    ...
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 ...
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
          ...
          case 6:   {
               //jilm + no_kov_luku
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDecreaseAC(IP_CONST_ACMODIFIERTYPE_SHIELD,1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDecreaseAC(IP_CONST_ACMODIFIERTYPE_SHIELD,1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                    ...
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 5:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_ACID,IP_CONST_DAMAGERESIST_15),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_5_PERCENT),no_Item);
                                 break;  }
                    ...
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGERESIST_5),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,5),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    ...
                    case 12: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(3),no_Item);
                                 ...
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,7),no_Item);
                                 break;  }
               }//konec vnitrniho switche
               no_udelejjmeno(no_Item);
               no_cenavyrobku(no_Item);
          ...
          case 7:   {
               ...
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDecreaseAC(IP_CONST_ACMODIFIERTYPE_SHIELD,1),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 3:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertySkillBonus(SKILL_PARRY,9),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_5_PERCENT),no_Item);
                                 break;  }
                    case 4:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(1),no_Item);
                    ...
                    case 7:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(2),no_Item);
                                 ...
                                 break;  }
                    case 8:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsDmgType(IP_CONST_DAMAGETYPE_PIERCING,4),no_Item);
                                 break;  }
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(3),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGERESIST_5),no_Item);
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,6),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
          ...
          case 8:   {
               //prastary dub + no_kov_luku
               switch (GetLocalInt(OBJECT_SELF,"no_kov_luku")) {
                    case 1:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_10_PERCENT),no_Item);
                                 break;  }
                    case 2:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    ...
                    case 9:  {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(3),no_Item);
                                 ...
                                 break;  }
                    case 10: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonusVsRace(IP_CONST_RACIALTYPE_UNDEAD,7),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEVULNERABILITY_25_PERCENT),no_Item);
                                 break;  }
                    case 11: {   AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyACBonus(4),no_Item);
                                 AddItemProperty(DURATION_TYPE_PERMANENT,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_COLD,IP_CONST_DAMAGERESIST_10),no_Item);
